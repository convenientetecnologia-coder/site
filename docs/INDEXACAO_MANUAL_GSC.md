...
| 2026-02-11 | Aracaju (SE) | urgente | https://www.fretesoumudancas.com.br/frete-urgente-em-aracaju/ | **Indexada (confirmado na Inspeção de URL)** | Detecção via sitemap; rastreada por Googlebot Smartphone |
...
| 2026-02-11 | Balneário Camboriú (SC) | fretes | https://www.fretesoumudancas.com.br/fretes-em-balneario-camboriu/ | **Indexada (confirmado na Inspeção de URL)** | Detecção via sitemap |
