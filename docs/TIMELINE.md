...
- **O que**: criadas e publicadas as 3 páginas de Teresina com sistema 100% GPT:
  ...
  - Bairros: 45 divididos em 3 blocos (15/15/15)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (8 títulos duplicados ajustados em `teresina.json`)
- **Por quê**: expandir cobertura orgânica no PI seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `4c759df` (repo `site`)
  - `src/_data/city_content/teresina.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (teresina habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `teresina` no `publish_config.json` e fazer deploy.
...
- **O que**: criadas e publicadas as 3 páginas de São Luís com sistema 100% GPT:
  ...
  - Bairros: 45 divididos em 3 blocos (15/15/15)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (5 títulos duplicados ajustados em `sao-luis.json`)
- **Por quê**: expandir cobertura orgânica no MA seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `6f1488d` (repo `site`)
  - `src/_data/city_content/sao-luis.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (sao-luis habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `sao-luis` no `publish_config.json` e fazer deploy.
...
- **O que**: criadas e publicadas as 3 páginas de Santos com sistema 100% GPT:
  ...
  - Conteúdo GPT 100% único: `sectionTitles`, `sectionDescriptions`, `demands`, `whenYes`, `whenNo`, `common`, `types`, `services`, `checklist`
  - Bairros: 31 divididos em 3 blocos (10/10/11)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (4 títulos duplicados ajustados em `santos.json`)
- **Por quê**: expandir cobertura orgânica no litoral paulista seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `544d8ca` (repo `site`)
  - `src/_data/city_content/santos.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (santos habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `santos` no `publish_config.json` e fazer deploy.

---

#### 2026-02-10 — [SITE] Santa Maria (RS): 3 páginas publicadas em production (sistema 100% GPT)

- **O que**: criadas e publicadas as 3 páginas de Santa Maria com sistema 100% GPT:
  ...
  - Bairros: 38 divididos em 3 blocos (12/13/13)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (3 títulos duplicados ajustados em `santa-maria.json`)
- **Por quê**: expandir cobertura orgânica no RS seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `9762cc6` (repo `site`)
  - `src/_data/city_content/santa-maria.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (santa-maria habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `santa-maria` no `publish_config.json` e fazer deploy.
...
- **O que**: criadas e publicadas as 3 páginas de Rio de Janeiro com sistema 100% GPT:
  ...
  - Bairros: 45 divididos em 3 blocos (15/15/15)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (2 títulos duplicados ajustados em `rio-de-janeiro.json`)
- **Por quê**: expandir cobertura orgânica no RJ seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `ef75393` (repo `site`)
  - `src/_data/city_content/rio-de-janeiro.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (rio-de-janeiro habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `rio-de-janeiro` no `publish_config.json` e fazer deploy.

---

#### 2026-02-10 — [SITE] Rio Branco (AC): 3 páginas publicadas em production (sistema 100% GPT)

- **O que**: criadas e publicadas as 3 páginas de Rio Branco com sistema 100% GPT:
  ...
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (3 títulos duplicados ajustados em `rio-branco.json`)
- **Por quê**: expandir cobertura orgânica no AC seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `ee4fb38` (repo `site`)
  - `src/_data/city_content/rio-branco.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (rio-branco habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `rio-branco` no `publish_config.json` e fazer deploy.
...
- **O que**: criadas e publicadas as 3 páginas de Petrolina com sistema 100% GPT:
  ...
  - Bairros: 42 divididos em 3 blocos (14/14/14)
  - Depoimentos: 36 (12 por tipo)
  - Validação anti-duplicação passou (2 títulos duplicados ajustados em `petrolina.json`)
- **Por quê**: expandir cobertura orgânica em PE seguindo protocolo ultra enterprise (unicidade 100% + gates de qualidade).
- **Evidência**:
  - Commit: `41c9a3f` (repo `site`)
  - `src/_data/city_content/petrolina.json`
  - `src/_data/neighborhoods.json`
  - `src/_data/testimonials.json`
  - `src/_data/publish_config.json` (petrolina habilitado em production)
- **Impacto**: +3 URLs indexáveis (via sitemap) para expansão de cobertura orgânica.
- **Rollback**: desabilitar `petrolina` no `publish_config.json` e fazer deploy.
